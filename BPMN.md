...
### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#event-definitions)Event Definitions
...
This code is baked into the Flowable application, so it works in combination with [???](https://www.flowable.com/open-source/docs/bpmn/bpmn/ch08-Forms.md#forms).
...
![bpmn.start.signal.event](https://www.flowable.com/open-source/docs/assets/bpmn/bpmn.start.signal.event.png)
...
### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#end-events)End Events
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#xml-representation-6)XML representation
...
### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#boundary-events)Boundary Events
...
![bpmn.boundary.error.example](https://www.flowable.com/open-source/docs/assets/bpmn/bpmn.boundary.error.example.png)
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#description-12)Description
...
### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#timer-intermediate-catching-event)Timer Intermediate Catching Event
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#example-4)Example
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#description-18)Description
...
### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#compensation-intermediate-throwing-event)Compensation Intermediate Throwing Event
...
### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#description-20)Description
...
![bpmn.default.sequence.flow](https://www.flowable.com/open-source/docs/assets/bpmn/bpmn.default.sequence.flow.png)
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#graphical-notation-23)Graphical notation
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#graphical-notation-25)Graphical Notation
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#custom-assignment-via-task-listeners)Custom Assignment via task listeners
...
Note: the same rules and logic that applied for the `JavaDelegate` applies for the `FutureJavaDelegate` as well. Keep in mind that when using field expression inject the evaluation of the expression should only be done before or after the execution is done (on the same thread as the process instance).

[[INTERNAL: non-public implementation classes]](https://www.flowable.com/open-source/docs/oss-introduction#internal-implementation-classes) It is also possible to provide a class that implements the *org.flowable.engine.impl.delegate.ActivityBehavior* interface. Implementations then have access to more powerful engine functionality, for example, to influence the control flow of the process. Note however that this is not a very good practice and should be avoided as much as possible. So, it is advisable to use the *ActivityBehavior* interface only for advanced use cases and if you know exactly what you're doing.

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#field-injection)Field Injection
...
To inject values that are dynamically resolved at runtime, expressions can be used. Those expressions can use process variables or Spring defined beans (if Spring is used). As noted in [Service Task Implementation](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#implementation), an instance of the Java class is shared among all process-instances in a service task when using the *flowable:class* attribute. To have dynamic injection of values in fields, you can inject value and method expressions in a org.flowable.engine.delegate.Expression that can be evaluated/invoked using the DelegateExecution passed in the execute method.
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#field-injection-and-thread-safety)Field injection and thread safety
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#service-task-results)Service task results
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#triggerable)Triggerable
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#handling-exceptions)Handling exceptions
...
##### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#throwing-bpmn-errors)Throwing BPMN Errors
...
The constructor argument is an error code, which will be used to determine the error handler that is responsible for the error. See [Boundary Error Event](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#error-boundary-event) for information on how to catch a BPMN Error.
...
##### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#exception-mapping)Exception mapping
...
##### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#exception-sequence-flow)Exception Sequence Flow

[[INTERNAL: non-public implementation classes]](https://www.flowable.com/open-source/docs/bpmn/internal)
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#using-a-flowable-service-from-within-a-javadelegate)Using a Flowable service from within a JavaDelegate
...
### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#web-service-task)Web Service Task

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#description-30)Description

A Web Service task is used to synchronously invoke an external Web service.

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#graphical-notation-30)Graphical Notation

A Web Service task is visualized in the same way as a Java service task.

![bpmn.web.service.task](https://www.flowable.com/open-source/docs/assets/bpmn/bpmn.web.service.task.png)

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#xml-representation-30)XML representation
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#web-service-task-io-specification)Web Service Task IO Specification
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#web-service-task-data-input-associations)Web Service Task data input associations
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#web-service-task-data-output-associations)Web Service Task data output associations
...
### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#business-rule-task)Business Rule Task

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#description-31)Description
...
If you want to plug in your own implementation of the rule task, for example, because you want to use Drools differently or you want to use a completely different rule engine, then you can use the class or expression attribute on the BusinessRuleTask and it will behave exactly like a [ServiceTask](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#java-service-task)

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#graphical-notation-31)Graphical Notation

A Business Rule task is visualized the with a table icon.

![bpmn.business.rule.task](https://www.flowable.com/open-source/docs/assets/bpmn/bpmn.business.rule.task.png)

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#xml-representation-31)XML representation
...
### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#email-task)Email Task
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#mail-server-configuration)Mail server configuration
...
| mailServerDefaultFrom | no | The default e-mail address of the sender of e-mails, when none is provided by the user. By default this is *flowable@localhost* |
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#defining-an-email-task)Defining an Email Task

The Email task is implemented as a dedicated [Service Task](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#java-service-task) and is defined by setting *'mail'* for the *type* of the service task.
...
The Email task is configured by [field injection](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#field-injection). All the values for these properties can contain EL expression, which are resolved at runtime during process execution. The following properties can be set:

| Property | Required? | Description |
| --- | --- | --- |
| to | yes | The recipients of the e-mail. Multiple recipients are defined in a comma-separated list |
| from | no | The sender e-mail address. If not provided, the [default configured](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#bpmnEmailTaskServerConfiguration) from address is used. |
...
| charset | no | Allows specification of the charset of the email, which is necessary for many non-English languages. |
| html | no | A piece of HTML that is the content of the e-mail. |
| text | no | The content of the e-mail, in case one needs to send plain, non-rich e-mails. Can be used in combination with *html*, for e-mail clients that don't support rich content. The email client can then fall back to this text-only alternative. |
...
| textVar | no | The name of a process variable that holds the plain text content of the e-mail. The key difference between this and *text* is that this content will have expressions replaced before being sent by the mail task. |
...
| exceptionVariableName | no | When email handling does not throw an exception because *ignoreException = true*, a variable with the given name is used to hold a failure message |

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#example-usage)Example usage
...
### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#http-task)Http Task
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#http-client-configuration)Http Client configuration
...
| Property | Required? | Description |
| --- | --- | --- |
| connectTimeout | no | Connection timeout in milliseconds.<br>By default set to 5000. |
| socketTimeout | no | Socket timeout in milliseconds.<br>By default set to 5000. |
| connectionRequestTimeout | no | Connection request timeout in milliseconds.<br>By default set to 5000. |
| requestRetryLimit | no | Request retry limit ('0' means do not retry).<br>By default set to 3. |
| disableCertVerify | no | Flag to disable SSL certificate verification.<br>By default set to false. |

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#defining-http-task)Defining Http Task

The Http task is implemented as a dedicated [Service Task](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#java-service-task) and is defined by setting *'http'* for the *type* of the service task.
...
The http client is abstracted through `FlowableHttpClient`. The default implementation when using the `flowable-http` dependency is based on the Apache Http Client. As Apache Http Client can be customized in many ways, all possible options are not used in the Http Client config. There is also an implementation based on the Spring WebClient, which will be used when the Apache Http Client is not on the classpath.
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#http-task-configuration)Http Task configuration

The Http task is configured by [field injection](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#field-injection). All the values for these properties can contain EL expression, which are resolved at runtime during execution. The following properties can be set:

| Property | Required? | Description |
| --- | --- | --- |
| requestMethod | yes | Request method<br>(GET,POST,PUT,DELETE). |
| requestUrl | yes | Request URL<br>(Example - [http://flowable.org](http://flowable.org/)). |
| requestHeaders | no | Line separated Http request headers.<br>Example -<br>Content-Type: application/json<br>Authorization: Basic aGFRlc3Q= |
| requestBody | no | Request body<br>Example - ${sampleBody} |
| requestTimeout | no | Timeout in milliseconds for the request<br>(Example - 5000).<br>Default is '0', meaning no timeout.<br>Please refer [Http Client configuration](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#bpmnHttpTaskClientConfiguration) for connection related timeouts. |
| disallowRedirects | no | Flag to disallow Http redirects.<br>Default is false.<br>(Example - true). |
| failStatusCodes | no | Comma separated list of Http response status codes to fail the request and throw a FlowableException.<br>Example: 400, 404, 500, 503<br>Example: 400, 5XX |
| handleStatusCodes | no | Comma separated list of status codes for which the task will throw BpmnError which can be caught by a boundary error event.<br>The error code of the BpmnError is 'HTTP<statuscode>'.<br>For example, 404 status code is set with error code 'HTTP404'.<br>3XX status codes are thrown only if 'disallowRedirects' field is also set.<br>Status codes in 'handleStatusCodes' override those in 'failStatusCodes' when they are set in both.<br>Example: 400, 404, 500, 503<br>Example: 3XX, 4XX, 5XX<br> |
...
| saveRequestVariables | no | Flag to save request variables.<br>By default, only response related variables are stored as variables. |
| saveResponseParameters | no | Flag to save all response variables including HTTP status, headers etc.<br>By default, only the response body is stored as a variable. |
| resultVariablePrefix | no | Prefix for the execution variable names.<br>If prefix is not set, variables will be saved with name as '<taskId>FieldName'.<br>For example, requestUrl is saved as 'task7RequestUrl' for task with id 'task7'. |
...
| saveResponseVariableAsJson | no | If resolves to true, the response body value will be stored as a JSON variable instead of a String. This is useful if the HTTP service returns JSON and you want to reference the fields using the dot notation (e.g. *myResponse.user.name*) later on. |
| parallelInSameTransaction | - | If resolves to true, the HTTP call will be done on a different thread and thus making it possible to execute more HTTP tasks in parallel. This is useful when parallel gateways are used and there are multiple HTTP tasks in the parallel flows. |
| httpActivityBehaviorClass | no | Full class name of custom extension of org.flowable.engine.impl.bpmn.http.DefaultBpmnHttpActivityDelegate. |
...
| responseHeaders | Yes | Line separated Http response headers.<br>Example -<br>Content-Type: application/json<br>Content-Length: 777 |
| responseBody | Yes | Response body as string, if any. |
| errorMessage | Yes | Ignored error message, if any. |

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#result-variables)Result variables
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#example-usage-1)Example usage
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#error-handling)Error handling
...
The Http task can be configured to handle the exceptions and http status by setting 'failStatusCodes' and/or 'handleStatusCodes' fields. Refer [Http Task configuration](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#-http-task-configuration).
...
##### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#fail-on-400-and-5xx-async-http-task-and-retry-with-failedjobretrytimecycle)Fail on '400' and 5XX, async http task and retry with failedJobRetryTimeCycle
...
##### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#handle-400-as-bmpnerror)Handle '400' as BmpnError
...
##### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#ignore-exceptions)Ignore exceptions.
...
##### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#exception-mapping-1)Exception mapping

Refer [Exception mapping](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#exception-mapping)

### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#camel-task)Camel Task
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#defining-a-camel-task)Defining a Camel Task

The Camel task is implemented as a dedicated [Service Task](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#java-service-task) and is defined by setting *'camel'* for the *type* of the service task.
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#simple-camel-call-example)Simple Camel Call example
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#ping-pong-example)Ping Pong example
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#returning-back-the-variables)Returning back the variables
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#asynchronous-ping-pong-example)Asynchronous Ping Pong example
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#instantiate-workflow-from-camel-route)Instantiate workflow from Camel route
...
### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#manual-task)Manual Task

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#description-32)Description
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#graphical-notation-32)Graphical Notation

A manual task is visualized as a rounded rectangle, with a little 'hand' icon in the upper left corner

![bpmn.manual.task](https://www.flowable.com/open-source/docs/assets/bpmn/bpmn.manual.task.png)

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#xml-representation-32)XML representation
...
### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#java-receive-task)Java Receive Task

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#description-33)Description
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#graphical-notation-33)Graphical notation
...
![bpmn.receive.task](https://www.flowable.com/open-source/docs/assets/bpmn/bpmn.receive.task.png)

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#xml-representation-33)XML representation
...
### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#shell-task)Shell Task

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#description-34)Description
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#defining-a-shell-task)Defining a Shell task

The Shell task is implemented as a dedicated [Service Task](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#java-service-task) and is defined by setting *'shell'* for the *type* of the service task.
...
The Shell task is configured by [field injection](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#field-injection). All the values for these properties can contain EL expression, which are resolved at runtime during process execution. The following properties can be set:

| Property | Required? | Type | Description | Default |
| --- | --- | --- | --- | --- |
| command | yes | String | Shell command to execute. |  |
| arg1-5 | no | String | Parameter 1 to Parameter 5 |  |
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#example-usage-2)Example usage
...
### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#external-worker-task)External Worker Task

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#description-35)Description
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#defining-an-external-worker-task)Defining an External Worker Task

The External Worker task is implemented as a dedicated [Service Task](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#java-service-task) and is defined by setting *'external-worker'* for the *type* of the service task.
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#example-usage-3)Example usage
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#acquiring-external-worker-job)Acquiring External Worker Job
...
An `AcquiredExternalWorkerJob` also has access to the Process variables. When the External Worker Task is exclusive, acquiring the job will lock the Process Instance.

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#completing-an-external-worker-job)Completing an External Worker Job
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#error-handling-for-an-external-worker-job)Error handling for an External Worker Job
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#querying-external-worker-jobs)Querying External Worker Jobs
...
### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#execution-listener)Execution listener
...
Execution listeners also support using a delegateExpression, [similar to a service task](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#xml-representation).
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#field-injection-on-execution-listeners)Field injection on execution listeners

When using an execution listener that is configured with the class attribute, field injection can be applied. This is exactly the same mechanism as used in [Service task field injection](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#field-injection), which contains an overview of the possibilities provided by field injection.
...
Note that the same rules with regards to thread-safety apply to service tasks. Please read the [relevant section](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#field-injection-and-thread-safety) for more information.

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#throwing-bpmn-error-in-execution-listeners)Throwing BPMN Error in Execution Listeners

It is possible to throw BPMN Errors out of execution listener code, which is caught by a matching [error boundary event](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#error-boundary-event) or [error start event](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#error-start-event) in the model. This can be done using the Flowable `org.flowable.engine.delegate.BpmnError` class. See section [throwing BPMN Errors](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#throwing-bpmn-errors) for examples and further description.
...
The following image illustrates that:![bpmn.executionlistener.bpmnerror](https://www.flowable.com/open-source/docs/assets/bpmn/bpmn.executionlistener.bpmnerror.png)
...
### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#task-listener)Task listener

A *task listener* is used to execute custom Java logic or an expression on the occurrence of a certain task-related event.

A task listener can only be added in the process definition as a child element of a [user task](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#user-task). Note that this also must happen as a child of the *BPMN 2.0 extensionElements* and in the *flowable* namespace, since a task listener is a Flowable-specific construct.
...
- delegateExpression allows you to specify an expression that resolves to an object implementing the TaskListener interface, [similar to a service task](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#xml-representation).
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#throwing-bpmn-error-in-task-listeners)Throwing BPMN Error in Task Listeners

Jump to section [Throwing BPMN Error in Execution Listeners](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#throwing-bpmn-error-in-execution-listeners) as the same rules apply for task listeners.

### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#multi-instance-for-each)Multi-instance (for each)

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#description-36)Description
...
- [User Task](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#user-task)

- [Script Task](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#script-Task)

- [Java Service Task](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#java-service-task)

- [Web Service Task](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#web-service-task)

- [Business Rule Task](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#business-rule-task)

- [Email Task](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#email-task)

- [Manual Task](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#manual-task)

- [Receive Task](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#java-receive-task)

- [(Embedded) Sub-Process](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#aocess)

- [Call Activity](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#call-activity-(sub-process))

A [Gateway](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#gateways) or [Event](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#events) cannot become multi-instance.
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#graphical-notation-34)Graphical notation
...
![bpmn.multi.instance](https://www.flowable.com/open-source/docs/assets/bpmn/bpmn.multi.instance.png)

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#xml-representation-34)XML representation
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#boundary-events-and-multi-instance)Boundary events and multi-instance

Since a multi-instance is a regular activity, it is possible to define a [boundary event](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#boundary-events) on its boundary. In the case of an interrupting boundary event, when the event is caught, all instances that are still active will be destroyed. Take, for example, the following multi-instance sub-process:

![bpmn.multi.instance.boundary.event](https://www.flowable.com/open-source/docs/assets/bpmn/bpmn.multi.instance.boundary.event.png)
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#multi-instance-and-execution-listeners)Multi instance and execution listeners
...
### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#compensation-handlers)Compensation Handlers

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#description-37)Description
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#graphical-notation-35)Graphical notation
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#xml-representation-35)XML representation
...
## [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#sub-processes-and-call-activities)Sub-Processes and Call Activities

### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#sub-process)Sub-Process

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#description-38)Description
...
- A Sub-Process creates a new scope for events. Events that are thrown during execution of the Sub-Process can be caught by [a boundary event](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#boundary-events) on the boundary of the Sub-Process, creating a scope for that event limited to the Sub-Process.
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#graphical-notation-36)Graphical Notation
...
![bpmn.collapsed.subprocess](https://www.flowable.com/open-source/docs/assets/bpmn/bpmn.collapsed.subprocess.png)

If the Sub-Process is *expanded*, the steps of the Sub-Process are displayed within the Sub-Process boundaries:

![bpmn.expanded.subprocess](https://www.flowable.com/open-source/docs/assets/bpmn/bpmn.expanded.subprocess.png)
...
![bpmn.subprocess.with.boundary.timer](https://www.flowable.com/open-source/docs/assets/bpmn/bpmn.subprocess.with.boundary.timer.png)

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#xml-representation-36)XML representation
...
### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#event-sub-process)Event Sub-Process

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#description-39)Description
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#graphical-notation-37)Graphical Notation

An Event Sub-Process can be visualized as an [embedded sub-process](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#graphical-notation) with a dotted outline.

![bpmn.subprocess.eventSubprocess](https://www.flowable.com/open-source/docs/assets/bpmn/bpmn.subprocess.eventSubprocess.png)

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#xml-representation-37)XML representation
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#example-6)Example
...
![bpmn.subprocess.eventSubprocess.example.1](https://www.flowable.com/open-source/docs/assets/bpmn/bpmn.subprocess.eventSubprocess.example.1.png)
...
![bpmn.subprocess.eventSubprocess.example.2a](https://www.flowable.com/open-source/docs/assets/bpmn/bpmn.subprocess.eventSubprocess.example.2a.png)

As opposed to:

![bpmn.subprocess.eventSubprocess.example.2b](https://www.flowable.com/open-source/docs/assets/bpmn/bpmn.subprocess.eventSubprocess.example.2b.png)
...
### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#transaction-sub-process)Transaction sub-process

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#description-40)Description
...
![bpmn.transaction.subprocess.example.1](https://www.flowable.com/open-source/docs/assets/bpmn/bpmn.transaction.subprocess.example.1.png)

Relation to ACID transactions: it is important not to confuse the BPMN transaction sub-process with technical (ACID) transactions. The BPMN transaction sub-process is not a way to scope technical transactions. In order to understand transaction management in Flowable, read the section on [concurrency and transactions](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#transactions-and-concurrency). A BPMN transaction is different from a technical transaction in the following ways:
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#graphical-notation-38)Graphical Notation

A transaction sub-process is visualized as a an [embedded sub-process](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#graphical-notation) with a double outline.

![bpmn.transaction.subprocess](https://www.flowable.com/open-source/docs/assets/bpmn/bpmn.transaction.subprocess.png)

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#xml-representation-38)XML representation
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#example-7)Example

The following is an example of a transaction sub-process:

![bpmn.transaction.subprocess.example.2](https://www.flowable.com/open-source/docs/assets/bpmn/bpmn.transaction.subprocess.example.2.png)

### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#call-activity-sub-process)Call activity (sub-process)

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#description-41)Description

BPMN 2.0 makes a distinction between a regular *[sub-process](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#aocess)*, often also called *embedded sub-process*, and the call activity, which looks very similar. From a conceptual point of view, both will call a sub-process when the process execution arrives at the activity.

The difference is that the call activity references a process that is external to the process definition, whereas the *[sub-process](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#aocess)* is embedded within the original process definition. The main use case for the call activity is to have a reusable process definition that can be called from multiple other process definitions.
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#graphical-notation-39)Graphical Notation

A call activity is visualized in the same way as a [sub-process](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#graphical-notation), but with a thick border (collapsed and expanded). Depending on the modeling tool, a call activity can also be expanded, but the default visualization is the collapsed sub-process representation.

![bpmn.collapsed.call.activity](https://www.flowable.com/open-source/docs/assets/bpmn/bpmn.collapsed.call.activity.png)

#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#xml-representation-39)XML representation
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#passing-variables)Passing variables
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#reference-the-process-from-the-same-deployment)Reference the process from the same deployment
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#reference-the-process-definition-by-id)Reference the process definition by id
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#example-8)Example
...
![bpmn.call.activity.super.process](https://www.flowable.com/open-source/docs/assets/bpmn/bpmn.call.activity.super.process.png)
...
![bpmn.call.activity.sub.process](https://www.flowable.com/open-source/docs/assets/bpmn/bpmn.call.activity.sub.process.png)
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#async-completion)Async completion
...
![bpmn.call.activity.async.complete](https://www.flowable.com/open-source/docs/assets/bpmn/bpmn.call.activity.async.complete.png)
...
## [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#transactions-and-concurrency)Transactions and Concurrency

### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#asynchronous-continuations)Asynchronous Continuations
...
![async.example.no.async](https://www.flowable.com/open-source/docs/assets/bpmn/async.example.no.async.PNG)
...
![async.example.async](https://www.flowable.com/open-source/docs/assets/bpmn/async.example.async.PNG)
...
### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#fail-retry)Fail Retry
...
### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#exclusive-jobs)Exclusive Jobs
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#why-exclusive-jobs)Why exclusive Jobs?

Consider the following process definition:

![bpmn.why.exclusive.jobs](https://www.flowable.com/open-source/docs/assets/bpmn/bpmn.why.exclusive.jobs.png)
...
#### [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#what-are-exclusive-jobs)What are exclusive jobs?
...
## [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#process-initiation-authorization)Process Initiation Authorization
...
## [](https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#data-objects)Data objects
